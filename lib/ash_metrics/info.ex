defmodule AshMetrics.Info do
  ...
  (`metrics/1`, `metrics_options/1`, `metrics_name/1`, `metrics_name!/1`,
  `metrics_poller/1`, `metrics_poller!/1`) this module provides the lookups the
  rest of the package uses: `metric/2`, `metric!/2`, `name/1` and `poller/1`.
  """
  ...
  configured `AshMetrics.Config.poller/0` otherwise. Read it rather than the
  configuration directly: an application may poll one resource from its job
  queue and the rest from the default process.
  """
